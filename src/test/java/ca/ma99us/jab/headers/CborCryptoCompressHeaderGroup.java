...
@Data
public class CborCryptoCompressHeaderGroup<P> extends AbstractHeaderGroup<P> {
    ...
    protected JabHeader<P>[] headers() {
        return new JabHeader[]{checksumHeader, cborArrayHeader, cryptoHeader, compressHeader, toStringHeader};
    }
}
